...
//		  { "*", "*", "*", "*", "*", "*", "*", "*" }};
	...
	private static final Cell[][] testGrid1 = {
			{ new Cell(WALL, 0, 0), new Cell(WALL, 0, 1), new Cell(WALL, 0, 2), new Cell(WALL, 0, 3), new Cell(WALL, 0, 4), new Cell(WALL, 0, 5) },
			{ new Cell(WALL, 1, 0), new Cell(FLOOR, 1, 1), new Cell(FLOOR, 1, 2), new Cell(FLOOR, 1, 3), new Cell(FLOOR, 1, 4), new Cell(WALL, 1, 5) },
			{ new Cell(WALL, 2, 0), new Cell(FLOOR, 2, 1), new Cell(FLOOR, 2, 2), new Cell(FLOOR, 2, 3), new Cell(FLOOR, 2, 4), new Cell(EXIT, 2, 5) },
			{ new Cell(WALL, 3, 0), new Cell(FLOOR, 3, 1), new Cell(FLOOR, 3, 2), new Cell(FLOOR, 3, 3), new Cell(FLOOR, 3, 4), new Cell(WALL, 3, 5) },
			{ new Cell(WALL, 4, 0), new Cell(FLOOR, 4, 1), new Cell(FLOOR, 4, 2), new Cell(FLOOR, 4, 3), new Cell(FLOOR, 4, 4), new Cell(WALL, 4, 5) }, 
			{ new Cell(WALL, 5, 0), new Cell(WALL, 5, 1), new Cell(WALL, 5, 2), new Cell(WALL, 5, 3), new Cell(WALL, 5, 4), new Cell(WALL, 5, 5)}};

	private static ArrayList<Block> makeTest1Blocks() {
		ArrayList<Block> blocks = new ArrayList<Block>();
		blocks.add(new Block(2, 1, 3, HORIZONTAL));
		return blocks;
	}
...
//		Block block = new Block(2, 1, 3, HORIZONTAL);
...
//		System.out.println();
		...
		Board board2 = new Board(cells, blocks);
...
//		System.out.println();
//		
//		System.out.println(board2.isGameOver());
//		System.out.println();
//		
//		board2.reset();
//		System.out.println(board2.toString());
